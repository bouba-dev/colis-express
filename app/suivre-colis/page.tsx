      ...
      <main className="flex flex-1 flex-col items-center p-4">
        <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-lg">
          ...
          <div className="mb-4 flex items-center gap-2">
            <Input placeholder="ML-24037-XYZ12345" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
          ...
          <div className="space-y-4">
            {filteredColis.map((item) => (
              <div
                key={item.numero}
                className="rounded-lg border border-gray-200 p-4 hover:border-blue-300 hover:bg-blue-50"
              >
